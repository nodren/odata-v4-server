...
exports.isStream = exports.isPromise = exports.isIterator = exports.getAllPropertyNames = exports.getFunctionParameters = void 0;
const stream_1 = require("stream");
const result_1 = require("./result");
const patternSource = '[^(]*\\(([^)]*)\\)';
const pattern = new RegExp(patternSource);
exports.getFunctionParameters = function (fn, name) {
    const params = typeof name == 'string' && typeof fn[name] == 'function'
